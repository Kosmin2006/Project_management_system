...
public class TokenFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public TokenFilter(TokenGenerator tokenGenerator, AppProfileService appProfileService) {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (tokenGenerator.validateToken(token)) {
            ...
            UserDetails userDetails = appProfileService.loadUserByUsername(username);
